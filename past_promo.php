...
<h2 class="te">ENTER NEW PROMOTION DATA</h2><hr>
  <form action="store_past.php" method="POST">
    ...
    <label for="fname">Promotion ID.</label>
    <input type="text"  name="pid" placeholder="Promotion ID...">
    ...
    <input type="number" class="form-control"  name="pname" placeholder="Amount spent...">
...
<?php 
$usw='select * from student_data where flag=0;';
$od=$conn->query($usw);
foreach($od as $o){
